...
public class PayFragment extends Fragment implements DingdanViewAPI {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        dingdanPresenter = new DingdanPresenter(getContext(), this);
...
//        Log.d("aaa", "aa" + dingdanBean.getData().toString());
    ...
    public void onDestroy() {
        super.onDestroy();
        if (dingdanPresenter != null) {
            dingdanPresenter = null;
        }
    }
}
